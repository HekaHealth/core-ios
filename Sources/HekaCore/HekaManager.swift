...
//        dataType: String, startDate: Date, endDate: Date,
//        completion: @escaping (Double?) -> Void
//    ) {
//        if let result =  healthStore.getAggregatedValueCount(startDate: startDate, endDate: endDate, dataTypeKey: dataType) {
//            completion(result);
//        } else {
//            completion(nil);
//        }
//    }
    ...
    public func getAggregatedValueForDataType(dataType: String, startDate: Date, endDate: Date, completion: @escaping (Double?) -> Void) {
        healthStore.getAggregatedValueCount(startDate: startDate, endDate: endDate, dataTypeKey: dataType) { result in
            completion(result)
        }
    }
}
